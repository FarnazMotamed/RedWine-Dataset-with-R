...
grid.arrange( ggplot(aes(x=quality), 
        data = RedWineData) +
  geom_histogram( bins = 30) ,
   ggplot(aes(x=1, y=quality), 
        data = RedWineData) +
  geom_boxplot( )  , nrow =1)

grid.arrange( ggplot(aes(x=sulphates), 
        data = RedWineData) +
  geom_histogram( bins = 30) ,
   ggplot(aes(x=1, y=sulphates), 
        data = RedWineData) +
  geom_boxplot( )  , nrow =1)

grid.arrange( ggplot(aes(x=pH), 
        data = RedWineData) +
  geom_histogram( bins = 30) ,
   ggplot(aes(x=1, y=pH), 
        data = RedWineData) +
...
grid.arrange( ggplot(aes(x=density), 
        data = RedWineData) +
  geom_histogram( bins = 30) ,
   ggplot(aes(x=1, y=density), 
        data = RedWineData) +
  geom_boxplot( )  , nrow =1)

grid.arrange( ggplot(aes(x=total.sulfur.dioxide), 
        data = RedWineData) +
  geom_histogram( bins = 30) ,
...
grid.arrange( ggplot(aes(x=free.sulfur.dioxide), 
        data = RedWineData) +
  geom_histogram( bins = 30) ,
...
grid.arrange( ggplot(aes(x=chlorides), 
        data = RedWineData) +
  geom_histogram( bins = 30) ,
   ggplot(aes(x=1, y=chlorides), 
        data = RedWineData) +
  geom_boxplot( )  , nrow =1)

grid.arrange( ggplot(aes(x=residual.sugar), 
        data = RedWineData) +
  geom_histogram( bins = 30) ,
   ggplot(aes(x=1, y=residual.sugar), 
        data = RedWineData) +
  geom_boxplot( )  , nrow =1) 

grid.arrange( ggplot(aes(x=citric.acid), 
        data = RedWineData) +
  geom_histogram( bins = 30) ,
   ggplot(aes(x=1, y=citric.acid), 
        data = RedWineData) +
  geom_boxplot( )  , nrow =1)

grid.arrange( ggplot(aes(x=volatile.acidity), 
        data = RedWineData) +
  geom_histogram( bins = 30) ,
   ggplot(aes(x=1, y=volatile.acidity), 
        data = RedWineData) +
  geom_boxplot( )  , nrow =1)

grid.arrange( ggplot(aes(x=fixed.acidity), 
        data = RedWineData) +
  geom_histogram( bins = 30) ,
   ggplot(aes(x=1, y=fixed.acidity), 
        data = RedWineData) +
  geom_boxplot( )  , nrow =1)
```
...
ggplot(data = RedWineData,aes(x = citric.acid, 
                        y = volatile.acidity,color = quality)) +geom_point()
...
ggplot(data = subset(RedWineData ,qualityrating != 'average'), 
       aes(x = volatile.acidity,
            y = alcohol, color = factor(quality))) + geom_point(alpha = 0.8, size = 2) + 
  geom_smooth(method = "lm", se = FALSE,size=1) +
...
### Description Three
As I have identified it at the first plot here,
higher acidity or lower pH is recognized in higher quality wines.
